...
export default function EventDetailsDescriptionRow() {

    return (

        <Row className={"EventDetailsDescriptionRowContainer"}>

            <Col>

                <Row>
                    <img
                        className={"EventDetailsDescriptionRowImage"}
                ...
                <Row>
                    ...
                    <h className={"EventDetailsDescriptionRowText"}>
                        ...
                        <a className={"EventDetailsDescriptionRowTextLink"} href={"#"}>~Janek126p</a>
